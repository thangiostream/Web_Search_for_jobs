...
<meta charset="utf-8">
<title>
Job search Az <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+84) 0772568859</p>
...
Job search Az <!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
...
Tìm kiếm việc làm <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">
Việc làm theo công ty</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">
Công việc theo chức năng</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">
Công việc theo tiêu đề</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">
Công việc phổ biến <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                                ...
                                if (isset($_GET['search'])) {
                                  # code...
                                   if ($result->CATEGORY==$_GET['search']) {
                                     # code...
                                    $viewresult = '<li class="active"><a href="'.web_root.'index.php?q=category&search='.$result->CATEGORY.'">'.$result->CATEGORY.' Việc làm</a></li>';
                                   }else{
                                    $viewresult = '<li><a href="'.web_root.'index.php?q=category&search='.$result->CATEGORY.'">'.$result->CATEGORY.' Việc làm</a></li>';
                                   }
                                }else{
                                    $viewresult = '<li><a href="'.web_root.'index.php?q=category&search='.$result->CATEGORY.'">'.$result->CATEGORY.' Việc làm</a></li>';
                                } 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">
Công ty</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">
Tuyển dụng ngay bây giờ</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About">
Về chúng tôi</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='Contact'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=Contact">
Liên hệ</a></li>
                    </ul>
                </div>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Liên hệ của chúng tôi</h5>
          <address>
          <strong>
Công ty chúng tôi</strong><br>
         170 An Dương Vương , phường Nguyễn Văn Cừ , Tp Quy Nhơn , Bình Định<br>
           Việt Nam </address>
          <p>
            <i class="icon-phone"></i> (84+) 0772568859<br>
            <i class="icon-envelope-alt"></i> cntt.nguyenvanthang@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">
Trang chủ</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">
Công ty</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">
Tuyển dụng</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Về chúng tôi</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=Contact">
