...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Job search Az</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Job search Az</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'company') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/company/">
            <i class="fa fa-building"></i> <span>Công ty</span> 
          </a>
        </li>
        ...
        <li class="<?php echo (currentpage() == 'employee') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/employee/">
            <i class="fa fa-users"></i> <span>Người lao động</span> 
          </a>
        </li> 
        ...
        <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/category/">
            <i class="fa fa-list"></i> <span>Loại</span>  
          </a>
        </li> 
       <!--  <li class="treeview">
          <a href="#">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/user/">
            <i class="fa fa-user"></i> <span>Quản lý người dùng</span> </a>
        </li>
      ...
      <ol class="breadcrumb">
        <?php
          ...
          if ($title!='Home') {
            ...
            echo '<li><a href='.web_root.'admin/><i class="fa fa-dashboard"></i> Trang chủ</a></li>';
            echo  $active_title;
  ...
  <footer class="main-footer">
    ...
    <strong>Bản quyền &copy; 2024 <a href="#">Thắng Nguyễn</a>.</strong> Tất cả các quyền
    kín đáo.
  </footer>
