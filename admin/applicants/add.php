                  ...
                  <form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=add" method="POST">
                     ...
                     <div class="form-group">
                      <div class="col-md-8">
                        ...
                        "EMPLOYEEID">Mã hiệu công nhân :</label>
...
Chức vụ:</label>
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "
Chức vụ" type="text" any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div>  
