...
?> 
	<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header">Danh sách nhân viên <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Thêm nhân viên mới</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
						...
						<form class="wow fadeInDownaction" action="controller.php?action=delete" Method="POST">   		
							<table id="dash-table" class="table table-striped  table-hover table-responsive" style="font-size:12px" cellspacing="0">
							  ...
							  <thead>
							  	<tr>
							  		<th width="5%">Nhân viên Không</th>
							  		 <th>Tên</th>
							  		<th>Địa chỉ</th>
							  		 <th>Tình dục</th>
							  		 <th>Tuổi</th>
							  		 <th>Liên hệ với No</th>
							  		 <!-- <th>Department</th> -->
							  		 <th>Chức vụ</th>
							  		 <!-- <th>Work Status</th> -->
