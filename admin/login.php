...
Đăng nhập Job Search Az</h1>
    <hr/>
    <p><?php check_message(); ?></p>

    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Tài khoản" name="user_email">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Mật khẩu" name="user_pass">
...
if(isset($_POST['btnLogin'])){
  ...
  $h_upass = sha1($upass);
   ...
   if ($email == '' OR $upass == '') {
      ...
      message("
      Tên người dùng và mật khẩu không hợp lệ!", "error");
      redirect("login.php");
  ...
  //it creates a new objects of member
    ...
    if ($res==true) { 
       message("
       Bạn đăng nhập với tư cách ".$_SESSION['ROLE'].".","success");
      ...
      message("
      Tài khoản không tồn tại! Vui lòng liên hệ với Quản trị viên.", "error");
