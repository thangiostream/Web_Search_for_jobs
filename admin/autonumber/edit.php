...
?> 
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
            ...
            <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Cập nhật số tự động</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
                    ...
                    <div class="col-md-8">
                      ...
                      <input  type="hidden" name="AUTOID" id="AUTOID" value="<?php  echo $singleauto->AUTOID; ?>">
                         <input class="form-control input-sm" id="AUTOSTART" name="AUTOSTART" placeholder=
                            "Bắt đầu" type="text" value="<?php  echo $singleauto->AUTOSTART; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="AUTOEND" name="AUTOEND" placeholder=
                            "Kết thúc" type="text" value="<?php  echo $singleauto->AUTOEND; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="AUTOKEY" name="AUTOKEY" placeholder=
                            "Khoá" type="text" value="<?php  echo $singleauto->AUTOKEY; ?>">
                      </div>
                    </div>
                  </div>
