...
<div class="col-sm-12 content-header" style="">
Xem chi tiết</div>
...
Lương : <?php echo number_format($job->SALARIES,2);  ?></li>
...
Lĩnh vực tuyển dụng <?php echo $job->SECTOR_VACANCY; ?></li>
        </ul>
	</div>
	<div class="col-sm-12">
		<p>
...
Tệp đính kèm</p>
	<div class="col-sm-12 slider">
		 <h3>
Tải xuống sơ yếu lý lịch <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">
Đây</a></h3>
	</div>  
	<div class="col-sm-12">
		<p>
Nhận xét</p>
	...
	<div class="col-sm-12  submitbutton "> 
		<a href="index.php?view=appliedjobs" class="btn btn-primary fa fa-arrow-left">Quay lại</a>
	</div> 
</div>
</form>