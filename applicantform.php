      ...
      <div class="col-lg-3">
        <select class="form-control input-sm" name="month">
          ...
          <?php
             ...
             $mon = array('Tháng 1' => 1 ,'Tháng 2'=> 2,'Tháng 3' => 3 ,'Tháng 4'=> 4,'Tháng 5' => 5 ,'Tháng 6'=> 6,'Tháng 7' => 7 ,'Tháng 8'=> 8,'Tháng 9' => 9 ,'Tháng 10'=> 10,'Tháng 11' => 11 ,'Tháng 12'=> 11 );    
  ...
  <div class="col-md-11">
    ...
    <div class="col-md-8">
       ...
       <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
          "Số điện thoại" type="text" any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
    </div>
  </div>
</div> 
  ...
  <div class="col-md-11">
    ...
    <div class="col-md-8">
      ...
      <input  class="form-control input-sm" id="USERNAME" name="USERNAME" placeholder=
          "Tài khoản "    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
  </div>
</div>
